...
public class C extends Atraccion implements Serializable {
    ...
    public C(Responsables responsable, Ayudantes A1, Ayudantes A2, Ayudantes A3, Ayudantes A4, Ayudantes A5, Ayudantes A6) {
    ...
    public C(Responsables responsable, HashMap<Integer, Personal.Ayudantes> Ayudantes) {
        super(TipoDeAtraccion, responsable);
    ...
    public C(String nombre, int DNI, Ayudantes A1, Ayudantes A2, Ayudantes A3, Ayudantes A4, Ayudantes A5, Ayudantes A6) {
    ...
    public C(String nombre, int DNI, HashMap<Integer, Personal.Ayudantes> Ayudantes) {
        super(TipoDeAtraccion, nombre, DNI);
        if (nAyudantes == Ayudantes.size()) {
            this.Ayudantes = Ayudantes;
            LlenarAyudantes(nAyudantes, TipoDeAtraccion);
