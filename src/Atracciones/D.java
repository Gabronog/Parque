...
public class D extends Atraccion implements Serializable {
    ...
    public D(Responsables responsable, Ayudantes A1, Ayudantes A2, Ayudantes A3, Ayudantes A4, Ayudantes A5, Ayudantes A6) {
    ...
    public D(Responsables responsable, HashMap<Integer, Personal.Ayudantes> Ayudantes) {
        super(TipoDeAtraccion, responsable);
    ...
    public D(String nombre, int DNI, Ayudantes A1, Ayudantes A2, Ayudantes A3, Ayudantes A4, Ayudantes A5, Ayudantes A6) {
    ...
    public D(String nombre, int DNI, HashMap<Integer, Personal.Ayudantes> Ayudantes) {
        super(TipoDeAtraccion, nombre, DNI);
        if (nAyudantes == Ayudantes.size()) {
            this.Ayudantes = Ayudantes;
            LlenarAyudantes(nAyudantes, TipoDeAtraccion);
